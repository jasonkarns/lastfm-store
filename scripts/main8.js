...
(function($) {
    ...
    function removeAlbum(e){
        ...
        $131(this).closest("li").remove();
        var k = parseInt(this.id.substr(1));
        lfm.cart = lfm.cart.slice(0, k).concat(lfm.cart.slice(k+1));
        $(".count").text(lfm.cart.length + " Item" + (lfm.cart.length > 1?"s":""));
        $(".basket a").click();
    }
    ...
    $(document).ready(function() {
        ...
        $131("a.remove").live('click', removeAlbum);
