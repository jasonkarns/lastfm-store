    ...
    $.widget("ui.coverflow", {
        init: function() {
            ...
            this.items = $(this.options.items, this.element).bind("click", function() {
                self.moveTo(this);
                $(self.options.slider).slider("moveTo", self.current, null, true);
            });
            ...
            $(this.options.slider).show().slider({
                min: 0,
            ...
            $(this.options.caption).text(this.items[this.current].title).fadeIn();
        ...
        moveTo: function(item) {
            ...
            $(this.options.caption).text("").fadeOut("fast");
            ...
            $(this.options.caption).text(this.items[this.current].title).stop().fadeIn();
